...
5. This is only the frontend of the application and you will need to also clone the API for this app from my repository located [here](https://github.com/kyledavis109/Spotify-App-Express).
